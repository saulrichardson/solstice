#!/usr/bin/env python3
"""Direct test of catalog pipeline V2 without full imports."""
...
from src.injestion.catalog_pipeline_v2 import PDFElementCatalogV2
...
if __name__ == "__main__":
    print("PDF Catalog Pipeline V2 Test (Direct Import)")
    print("=" * 60)
