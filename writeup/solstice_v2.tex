...
% Include auto-generated statistics
\input{stats.tex}
...
\textbf{System Scale}: The current deployment has processed \documents{} clinical documents totaling \totalPages{} pages, containing \totalBlocks{} content blocks including \totalFigures{} figures and \totalTables{} tables—demonstrating the system's ability to handle real-world medical documentation at scale.
