...
% Labels
\node[right=0.2cm of extract, font=\small] {GPT-4};
\node[right=0.2cm of complete, font=\small] {GPT-4};
\node[right=0.2cm of verify, font=\small] {GPT-4};
\node[below=0.1cm of image, font=\small] {Vision};
