...
\begin{figure}[ht]
\centering
\fbox{\textit{[Layout visualization of FlublokOnePage marketing material]}}
...
\textit{Actual visualization available at:} \texttt{data/marketing\_cache/FlublokOnePage/visualizations/page\_001\_layout.png}
...
\begin{figure}[ht]
\centering
\fbox{\textit{[Layout visualization of scientific PDF page with mixed content]}}
...
\textit{Actual visualization available at:} \texttt{data/scientific\_cache/Hsiao\_et\_al.\_\_2023\_/visualizations/page\_003\_layout.png}
