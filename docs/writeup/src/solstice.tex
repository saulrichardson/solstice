...
\item \textbf{Completeness Checker}: Reviews verified evidence for gaps and searches for additional supporting content. Increases evidence coverage by identifying missing perspectives and feeding new findings back to verification.
...
\item \textbf{Stage 3}: Check for missing evidence types (gap analysis)
\end{itemize}
...
\begin{verbatim}
{
  ...
  "verified_evidence": [...],
  "document_content": "<full text>",
  "system_prompt": "Identify gaps and find missing evidence"
}
\end{verbatim}
...
{
  "coverage_assessment": {
    "aspects_covered": ["efficacy", "safety"],
    "aspects_missing": ["dosing", "contraindications"],
    "overall_coverage": "partial"
  },
  "additional_evidence": [
    {
      "quote": "<new evidence found>",
      "relevance": "<fills gap in...>",
      "aspect": "dosing"
    }
  ],
  "search_strategy": "<how gaps were addressed>"
}
\end{verbatim}
