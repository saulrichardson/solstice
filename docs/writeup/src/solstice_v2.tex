...
\item Achieves high verification rate across medical claims
...
\item Increases average evidence per claim through comprehensive search
\item Feeds new findings back to verification
\end{itemize}

\subsubsection{Image Evidence Analyzer}
\begin{itemize}[leftmargin=*,topsep=0pt,itemsep=0pt]
\item Analyzes images using vision models
\item Identifies images containing supporting evidence
