...
uBlok or placebo are shown in Table 1. Flublok was associated ith local injection site pain and muscle aches that were sign if antly more frequent than after saline placebo (P <.03 for pain). owever, 94% of all complaints of pain after Flublok were rated smild. Systemic symptoms following vaccination did not occur significantly different rates in vaccine and placebo recipients P > .05 for all comparisons). The most frequently reported sys- i fll ...(15% i b h
